...
<head>
    ...
    <style>
        ...
        .brand-logo { font-size: 1.5rem; font-weight: 700; color: var(--primary-color); padding: 2rem 1.5rem; display: flex; align-items: center; gap: 10px; }
        .nav-link { color: var(--secondary-color); font-weight: 500; padding: 0.8rem 1.5rem; margin: 0.2rem 1rem; border-radius: 12px; transition: all 0.2s; display: flex; align-items: center; gap: 12px; }
        ...
        /* Custom Table & Status */
        .custom-table thead th { border-bottom: none; color: #94a3b8; font-weight: 500; font-size: 0.85rem; text-transform: uppercase; }
        .custom-table td { vertical-align: middle; padding: 1rem 0.5rem; border-bottom: 1px solid #f1f5f9; }
        .status-badge { padding: 0.35em 0.8em; border-radius: 50rem; font-size: 0.75em; font-weight: 600; }
        .status-operational { background: #d1fae5; color: #065f46; }
        .status-service { background: #fee2e2; color: #991b1b; }
...
<div class="mt-auto p-4 border-top">
  ...
  <div class="p-4 mb-3">
             <div class="glass-card bg-primary text-white border-0 p-3" style="background: linear-gradient(135deg, #2563eb, #1e40af);">
                ...
                <button class="btn btn-sm btn-light w-100 fw-bold text-primary" fdprocessedid="vafm2m">Contact</button>
            </div>
        </div>  
		</div>
</nav>
