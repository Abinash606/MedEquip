...
<head>
    ...
    .avatar-cilrcle.a2{background: linear-gradient(135deg, rgba(96,165,250,.90), rgba(34,211,238,.70));} */
        ...
        .g-card .input-group .input-group-text,
        .g-card .input-group .form-control {
            border: 1px solid rgba(255, 255, 255, .12);
            background: rgba(255, 255, 255, .04);
            color: rgba(233, 237, 255, .86) !important;
        }
        ...
        .g-card .form-select option {
            color: #000 !important;
        }

        .glass-card .input-group .form-control::placeholder,
        ...
        <nav class="sidebar">
            ...
            <div class="d-flex align-items-center gap-2  p-2 text-primary fw-bold fs-4">
                <img src="<?= base_url('logo/assetiq logo.png') ?>" alt="assetIQ Logo"
                    style="max-height: 90px; width: auto; max-width: 100%; object-fit: contain;border-radius:6px"
                    class="nav-logo">
                <button class="sidebar-toggle d-none d-lg-block" type="button" aria-label="Toggle sidebar"
                    id="sidebarToggle">
                    <i class="bi bi-layout-sidebar-inset"></i>
                    <button class="sidebar-mtoggle d-lg-none ms-auto" type="button" aria-label="Toggle sidebar"
                        id="sidebar-mtoggle">
                        <i class="bi bi-layout-sidebar-inset"></i>
                    </button>
            </div>
