...
<head>
    ...
    <style>
        ...
        .section-header {
            ...
            color: var(--muted2); padding: 0 12px; margin: 12px 0 6px;
        }
        .nav-link {
        ...
        /* Tables */
        .service-table { --bs-table-bg: transparent; --bs-table-color: var(--text); --bs-table-border-color: rgba(255,255,255,.06); }
        .service-table thead th {
            font-size: 11px; letter-spacing: .18em; text-transform: uppercase;
            color: rgba(233,237,255,.55) !important;
            border-bottom: 1px solid rgba(255,255,255,.08) !important;
        }
        .service-table tbody td { border-bottom: 1px solid rgba(255,255,255,.06) !important; color: #fff; font-size: 14px; }
        .service-table tbody tr:hover { background: rgba(255,255,255,.04) !important; }
        ...
        table.dataTable tbody tr.odd>.sorting_1,table.dataTable tbody tr.even>.sorting_1,
        ...
        .dataTables_filter input,.dataTables_length select { color:#fff!important;background:rgba(255,255,255,.04)!important;border:1px solid rgba(255,255,255,.12)!important;border-radius:8px!important; }
        ...
        .dt-buttons .dt-button,.export-btn {
            ...
            color:#fff!important;border-radius:10px!important;padding:7px 14px;font-size:14px;
        }
        ...
        /* Progress circle */
        .progress-circle-inner { background: var(--panel,#0E1630); color:var(--text); }
...
<nav class="sidebar" id="sidebar">
    ...
    <div class="sidebar-footer">
        <div class="d-flex align-items-center gap-2">
            <?php $username = session('username') ?? 'Technician'; $initials = strtoupper(substr(trim($username),0,2)); ?>
            <div class="avatar-circle"><?= esc($initials) ?></div>
            <div class="small lh-sm">
                <div class="fw-semibold"><?= esc($username) ?></div>
                <a href="<?= site_url('logout') ?>" class="text-muted text-decoration-none" style="font-size:12px;">Logout</a>
            </div>
        </div>
    </div>
</nav>
