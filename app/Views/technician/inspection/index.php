    ...
    <div id="tech-inspection-workflow">
            ...
            <div class="d-flex justify-content-between align-items-start mt-2 mb-4">
                <div>
                    <div class="d-inline-flex align-items-center gap-2 mb-2 px-3 py-2 rounded-3"
                        ...
                        <span class="fw-bold" id="tech-insp-site-label" style="font-size:1rem;color:#1e293b;">Site: -</span>
                    </div>
                    <h2 class="fw-bold" id="tech-insp-title">-</h2>
                    <p class="text-muted">
                        <span id="tech-insp-id-label">-</span> &bull;
                ...
                <div class="text-end">
                    ...
                    <div class="dropdown">
                        <button class="btn btn-light dropdown-toggle" data-bs-toggle="dropdown" id="techStatusDropdown" type="button">
            ...
            <div class="glass-card p-3 mb-3">
                ...
                <div class="d-flex justify-content-center">
                    <div class="input-group" style="max-width:600px">
                        <input class="form-control" id="techAssetInput" placeholder="Scan or Enter Barcode..." type="text">
                        <button class="btn btn-primary" onclick="techHandleAssetGo()" type="button">
                            <i class="fa-solid fa-arrow-right"></i> Go
                        </button>
                    </div>
                </div>
                <p class="text-muted small mt-2">Devices only move to Inspected Items after the inspection result is recorded.</p>
            </div>
                ...
                <div class="card-header border-0 pt-3 pb-0">
                    <ul class="nav nav-tabs" id="techInspTabs" role="tablist">
                        <li class="nav-item" role="presentation">
                            <button class="nav-link active" data-bs-target="#tech-not-inspected" data-bs-toggle="tab" role="tab" type="button">
                                Not Inspected
                                <span class="badge rounded-pill ms-1" id="tech-not-inspected-count">0</span>
                            </button>
                        </li>
                        <li class="nav-item" role="presentation">
                            <button class="nav-link disabled" data-bs-target="#tech-inspect-device" data-bs-toggle="tab" id="tech-passfail-tab" role="tab" type="button" disabled>
                                Pass/Fail
                            </button>
                        </li>
                        <li class="nav-item" role="presentation">
                            <button class="nav-link" data-bs-target="#tech-inspected" data-bs-toggle="tab" role="tab" type="button">
                                Inspected Items
                                <span class="badge bg-success rounded-pill ms-1" id="tech-inspected-count">0</span>
                            </button>
                        </li>
                        <li class="nav-item" role="presentation">
                            <button class="nav-link" data-bs-target="#tech-inventory" data-bs-toggle="tab" role="tab" type="button">
                                All Inventory
                            </button>
                        </li>
                        <li class="nav-item" role="presentation">
                            <button class="nav-link" data-bs-target="#tech-archived" data-bs-toggle="tab" role="tab" type="button">
                                Archived Items
                            </button>
                        </li>
                        <li class="nav-item" role="presentation">
                            <button class="nav-link" data-bs-target="#tech-work-orders" data-bs-toggle="tab" id="tech-wo-tab" role="tab" type="button">
                                Work Orders
                            </button>
                        </li>
                        <li class="nav-item" role="presentation">
                            <button class="nav-link" data-bs-target="#tech-insp-reports" data-bs-toggle="tab" id="tech-reports-tab" role="tab" type="button">
                                Inspection Reports
                            </button>
                        </li>
                    </ul>
                    ...
                    <div class="tab-content">
                        ...
                        <div class="tab-pane fade p-4 show active" id="tech-not-inspected" role="tabpanel">
                            <div class="d-flex justify-content-between align-items-center mb-3 flex-wrap gap-2">
                                ...
                                <div class="tech-export-bar">
                                    <button class="tech-export-btn" onclick="techExportTable('copy','techNotInspTable')">Copy</button>
                                    <button class="tech-export-btn" onclick="techExportTable('csv','techNotInspTable','not-inspected')">CSV</button>
                                    <button class="tech-export-btn" onclick="techExportTable('excel','techNotInspTable','not-inspected')">Excel</button>
                                    <button class="tech-export-btn" onclick="techExportTable('pdf','techNotInspTable','not-inspected')">PDF</button>
                                </div>
                                <div class="input-group" style="max-width:300px">
                                    <span class="input-group-text border-end-0"><i class="fa-solid fa-search text-muted"></i></span>
                                    <input class="form-control border-start-0 ps-0" id="techNotInspSearch" placeholder="Search pending items..." type="text">
                                </div>
                            </div>
                            <div class="table-responsive">
                                <table class="table table-custom table-striped mb-0" id="techNotInspTable">
                                    <thead>
                                        <tr>
                                            <th>Action</th>
                                            <th>Asset #</th>
                                    ...
                                    <tbody id="techNotInspBody">
                                        <tr>
                                            <td colspan="6" class="text-center text-muted">Select a site to load inventory.</td>
                                        </tr>
                                    </tbody>
                                </table>
                            </div>
                                ...
                                <div class="glass-card mb-4">
                                    <div class="card-body">
                                        <div class="row g-3 align-items-center">
                                            ...
                                            <div class="col-md-9"><input class="form-control" id="techInspDept" placeholder="Department" type="text"></div>
                                            <div class="col-md-3 fw-semibold">Room:</div>
                                            <div class="col-md-9"><input class="form-control" id="techInspRoom" placeholder="Room" type="text"></div>
                                            <div class="col-md-3 fw-semibold">Serial #:</div>
                                            <div class="col-md-9"><input class="form-control" id="techInspSerial" placeholder="Serial #" type="text"></div>
                                            <div class="col-md-3 fw-semibold">Asset ID:</div>
                                            <div class="col-md-9"><input class="form-control" id="techInspAsset" readonly type="text"></div>
                                        ...
                                        <div class="row g-3">
                                            <div class="col-12">
                                                <div class="d-flex align-items-start gap-2">
                                                    <div class="fw-semibold" style="min-width:70px;padding-top:6px;">Notes:</div>
                                                    <textarea class="form-control" id="techInspNotes" placeholder="Enter service notes..." rows="4"></textarea>
                                                </div>
                                            </div>
                                            <div class="col-12 d-flex flex-wrap gap-2 pt-2">
                                                <button class="btn btn-success px-4" id="techBtnPass" type="button">Pass Inspection</button>
                                                <button class="btn btn-danger px-4" id="techBtnFail" type="button">Fail Inspection</button>
                                                <button class="btn btn-warning px-4 text-white" id="techBtnFailWO" type="button">Fail Inspection &amp; Open Work Order</button>
                                                <button class="btn btn-primary px-4" id="techBtnRepair" type="button">Repair Inspection</button>
                                                <button class="btn btn-secondary ms-auto" id="techBtnCancel" type="button">Cancel</button>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                        ...
                        <div class="tab-pane fade p-4" id="tech-inspected" role="tabpanel">
                            <div class="tech-inspected-topbar mb-4">
                                <div class="tech-inspected-left">
                                    ...
                                    <p class="mb-0" id="tech-inspected-subtitle">These items have been inspected.</p>
                                </div>
                                <div class="tech-inspected-center">
                                    <div class="tech-export-bar">
                                        <button class="tech-export-btn" onclick="techExportTable('copy','techInspectedTable')">Copy</button>
                                        <button class="tech-export-btn" onclick="techExportTable('csv','techInspectedTable','inspected-items')">CSV</button>
                                        <button class="tech-export-btn" onclick="techExportTable('excel','techInspectedTable','inspected-items')">Excel</button>
                                        <button class="tech-export-btn" onclick="techExportTable('pdf','techInspectedTable','inspected-items')">PDF</button>
                                    </div>
                                </div>
                                <div class="tech-inspected-right">
                                    <div class="input-group tech-inspected-search">
                                        ...
                                        <input class="form-control border-start-0 ps-0" id="techInspectedSearch" placeholder="Search inspected..." type="text">
                                    </div>
                                </div>
                            </div>
                                ...
                                <div class="table-responsive">
                                    <table class="table tech-counter-table mb-0">
                                        ...
                                        <tbody id="techDeviceCountBody">
                                            <tr>
                                                <td colspan="4" class="text-center text-muted py-3">No inspected items yet.</td>
                                            </tr>
                                        </tbody>
                                    </table>
                                </div>
                            ...
                            <div class="tech-items-table-wrap">
                                <div class="table-responsive">
                                    <table class="table table-custom tech-inspected-table mb-0" id="techInspectedTable">
                                        <thead>
                                            <tr>
                                        ...
                                        <tbody id="techInspectedBody">
                                            <tr id="techInspectedEmpty">
                                                <td colspan="9" class="text-center text-muted py-4">No inspected items yet.</td>
                                            </tr>
                                        </tbody>
                                    </table>
                                </div>
                        ...
                        <div class="tab-pane fade p-4" id="tech-inventory" role="tabpanel">
                            <div class="d-flex justify-content-between align-items-center mb-3 flex-wrap gap-2">
                                ...
                                <div class="tech-export-bar">
                                    <button class="tech-export-btn" onclick="techExportTable('copy','techInventoryTable')">Copy</button>
                                    <button class="tech-export-btn" onclick="techExportTable('csv','techInventoryTable','all-inventory')">CSV</button>
                                    <button class="tech-export-btn" onclick="techExportTable('excel','techInventoryTable','all-inventory')">Excel</button>
                                    <button class="tech-export-btn" onclick="techExportTable('pdf','techInventoryTable','all-inventory')">PDF</button>
                                </div>
                                <div class="input-group" style="max-width:300px">
                                    <span class="input-group-text border-end-0"><i class="fa-solid fa-search text-muted"></i></span>
                                    <input class="form-control border-start-0 ps-0" id="techInventorySearch" placeholder="Search inventory..." type="text">
                                </div>
                            </div>
                            <div class="table-responsive">
                                <table class="table table-custom table-striped mb-0" id="techInventoryTable">
                                    <thead>
                                        <tr>
                                            <th>Asset #</th>
                                            <th>Model</th>
                                    ...
                                    <tbody id="techInventoryBody">
                                        <tr>
                                            <td colspan="5" class="text-center text-muted">Select a site to load inventory.</td>
                                        </tr>
                                    </tbody>
                                </table>
                            </div>
                        ...
                        <div class="tab-pane fade p-4" id="tech-archived" role="tabpanel">
                            <div class="d-flex justify-content-between align-items-center mb-3 flex-wrap gap-2">
                                ...
                                <div class="tech-export-bar">
                                    <button class="tech-export-btn" onclick="techExportTable('copy','techArchivedTable')">Copy</button>
                                    <button class="tech-export-btn" onclick="techExportTable('csv','techArchivedTable','archived-items')">CSV</button>
                                    <button class="tech-export-btn" onclick="techExportTable('excel','techArchivedTable','archived-items')">Excel</button>
                                    <button class="tech-export-btn" onclick="techExportTable('pdf','techArchivedTable','archived-items')">PDF</button>
                                </div>
                                <div class="input-group" style="max-width:300px">
                                    <span class="input-group-text border-end-0"><i class="fa-solid fa-search text-muted"></i></span>
                                    <input class="form-control border-start-0 ps-0" id="techArchivedSearch" placeholder="Search archived..." type="text">
                                </div>
                            </div>
                            <div class="table-responsive">
                                <table class="table table-custom table-striped mb-0" id="techArchivedTable">
                                    <thead>
                                        <tr>
                                            <th>Asset #</th>
                                            <th>Model</th>
                        ...
                        <div class="tab-pane fade p-4" id="tech-work-orders" role="tabpanel">
                            ...
                            <div class="d-flex justify-content-between align-items-center flex-wrap gap-3 mb-3">
                                <div class="tech-export-bar">
                                    <button class="tech-export-btn" onclick="techExportTable('copy','techWOTable')">Copy</button>
                                    <button class="tech-export-btn" onclick="techExportTable('csv','techWOTable','work-orders')">CSV</button>
                                    <button class="tech-export-btn" onclick="techExportTable('excel','techWOTable','work-orders')">Excel</button>
                                    <button class="tech-export-btn" onclick="techExportTable('pdf','techWOTable','work-orders')">PDF</button>
                                </div>
                                <div class="input-group" style="max-width:300px">
                                    <span class="input-group-text border-end-0"><i class="fa-solid fa-search text-muted"></i></span>
                                    <input class="form-control border-start-0 ps-0" id="techWOSearch" placeholder="Search work orders..." type="text">
                                </div>
                            </div>
                            <div class="table-responsive">
                                <table class="table table-custom table-hover" id="techWOTable">
                                    ...
                                    <tbody id="techWOBody">
                                        <tr>
                                            <td colspan="10" class="text-center text-muted py-3">No work orders found.</td>
                                        </tr>
                                    </tbody>
                                </table>
                            </div>
                        ...
                        <div class="tab-pane fade p-4" id="tech-insp-reports" role="tabpanel">
                            ...
                            <div id="techReportsTabContent">
                                <p class="text-muted fst-italic">Complete an inspection to load the report here.</p>
                            </div>
                        </div>
                        ...
                        <div class="modal-body">
                            ...
                            <div class="row g-3">
                                <div class="col-md-6">
                                    ...
                                    <input class="form-control" id="techWOTitle" required type="text" placeholder="e.g., Equipment Failure - Urgent Repair">
                                </div>
                                <div class="col-md-6">
                                    <label class="form-label">Asset #</label>
                                    <input class="form-control" id="techWOAsset" placeholder="Enter asset to auto-fill" type="text">
                                </div>
                                <div class="col-md-6">
                                    <label class="form-label">Make</label>
                                    <input class="form-control" id="techWOMake" placeholder="Auto-filled" readonly type="text">
                                </div>
                                <div class="col-md-6">
                                    <label class="form-label">Model</label>
                                    <input class="form-control" id="techWOModel" placeholder="Auto-filled" readonly type="text">
                                </div>
                                <div class="col-md-6">
                                ...
                                <div class="col-12">
                                    ...
                                    <textarea class="form-control" id="techWODescription" rows="3" placeholder="Describe the issue and required repairs..."></textarea>
                                </div>
                            </div>
                        </div>
        ...
        <div class="modal fade" id="techNewInspModal" tabindex="-1" aria-hidden="true">
            <div class="modal-dialog modal-md">
                <div class="modal-content">
                    <div class="modal-header">
                        <h5 class="modal-title fw-bold"><i class="fa-solid fa-clipboard-check me-2"></i>New Inspection</h5>
                        <button class="btn-close" data-bs-dismiss="modal" type="button"></button>
                    </div>
                    <div class="modal-body">
                        <div id="techNewStep1">
                            ...
                            <p class="text-muted small">After selecting the site, you will enter the inspection detail view where you can scan asset barcodes and record results.</p>
                        </div>
                    </div>
                    <div class="modal-footer">
                ...
                <div class="modal-content" style="max-height:90vh;display:flex;flex-direction:column;">
                    <div class="modal-header flex-shrink-0">
                        <div>
                            ...
                            <div class="text-muted small">Asset not found - search the equipment database and add to this inspection.</div>
                        </div>
                        <button class="btn-close" data-bs-dismiss="modal" type="button"></button>
                    </div>
                    <form id="techAddDeviceForm" style="display:flex;flex-direction:column;flex:1;overflow:hidden;">
                        <div class="modal-body" style="overflow-y:auto;flex:1;">
                            ...
                            <div class="row g-3">
                                ...
                                <div class="col-md-4 position-relative">
                                    ...
                                    <input autocomplete="off" class="form-control" id="techAddModel" placeholder="Start typing..." type="text">
                                    <div class="list-group position-absolute w-100 d-none" id="techModelSuggestions"
                                        style="z-index:2000;max-height:250px;overflow-y:auto;top:calc(100% + 2px);left:0;"></div>
                                </div>
                                <div class="col-md-4">
                                    <label class="form-label">Serial #</label>
                                ...
                                <div class="col-md-6">
                                    ...
                                    <input class="form-control" id="techAddManufacturer" placeholder="Start typing..." type="text">
                                </div>
                                <div class="col-md-6">
                                ...
                                <div class="col-12">
                                    <label class="form-label">Description</label>
                                    <input class="form-control" id="techAddDescription" placeholder="Auto-filled when model is selected" type="text">
                                </div>
                                <div class="col-md-6">
                                ...
                                <div class="col-12">
                                    ...
                                    <textarea class="form-control" id="techAddNotes" placeholder="Optional" rows="3"></textarea>
                                </div>
                                <div class="col-12">
                                ...
                                <div class="col-12">
                                    ...
                                    <div class="d-flex flex-wrap gap-2">
                                        <button class="btn btn-success" id="techAddBtnPass" type="button"><i class="fa-solid fa-check me-1"></i>Pass</button>
                                        <button class="btn btn-danger" id="techAddBtnFail" type="button"><i class="fa-solid fa-xmark me-1"></i>Fail</button>
                                        <button class="btn btn-warning text-white" id="techAddBtnRepair" type="button"><i class="fa-solid fa-wrench me-1"></i>Repair</button>
                                    </div>
                        ...
                        <div class="modal-footer flex-shrink-0" style="border-top:1px solid rgba(255,255,255,0.1);background:inherit;">
                            <button class="btn btn-outline-secondary" data-bs-dismiss="modal" type="button">Cancel</button>
...
<script>
    document.addEventListener('DOMContentLoaded', function() {
        ...
        /* ================================================================
           DATATABLE CORE STRATEGY
           - refreshDataTable() : call BEFORE any innerHTML change
             -> destroys old DT instance so no stale column mapping
           - initExportDataTable() : called ONLY when export button clicked
             -> always destroys first then creates fresh on current DOM rows
           This prevents "Unknown parameter" and "_DT_CellIndex" errors.
        ================================================================ */
        ...
        function initExportDataTable(tableId, title) {
            ...
            // Always destroy before init to ensure clean state
            if ($.fn.DataTable.isDataTable(sel)) {
                $(sel).DataTable().destroy();
            }
        ...
        /* Export handler - note: pass TABLE id, not tbody id */
        window.techExportTable = function(type, tableId, filename) {
            // CSV uses plain JS - no DataTables needed
            if (type === 'csv') {
                const table = document.getElementById(tableId);
                if (!table) return;
                const rows = Array.from(table.querySelectorAll('tbody tr')).filter(r => r.style.display !== 'none');
                const matrix = rows.map(row => Array.from(row.querySelectorAll('td')).map(td => td.innerText.replace(/\n/g, ' ').trim()));
            ...
            // For copy/excel/pdf: always reinit fresh then trigger
            const title = filename || tableId;
            const dt = initExportDataTable(tableId, title);
            if (!dt) {
        ...
        function resultBadge(res) {
            ...
            if (r === 'Pass') return '<span class="text-success fw-semibold"><i class="fa-solid fa-check me-1"></i>Pass</span>';
            if (r === 'Fail') return '<span class="text-danger fw-semibold"><i class="fa-solid fa-xmark me-1"></i>Fail</span>';
            if (r === 'Repair') return '<span class="text-warning fw-semibold"><i class="fa-solid fa-wrench me-1"></i>Repair</span>';
        ...
        /* Start inspection - FIX: blur() prevents aria-hidden focus warning */
        ...
        window.techViewInspection = function(groupId, siteName, inspType, inspDisplayId, techName, siteId) {
            ...
            document.getElementById('tech-insp-id-label').textContent = 'Inspection #' + (inspDisplayId || groupId || '-');
        ...
        window.techHandleAssetGo = function() {
            ...
            fetch(URL_GET_EQUIPMENT + '?asset_tag=' + encodeURIComponent(assetTag) + '&site_id=' + CURRENT_SITE_ID, {
                    headers: {
                ...
                .then(data => {
                    if (data.found) {
                        ...
                        bootstrap.Modal.getOrCreateInstance(document.getElementById('techAddDeviceModal')).show();
                    }
                })
        ...
        function openPassFailTab(equipment) {
            ...
            document.getElementById('techInspModel').textContent = [equipment.make, equipment.model].filter(Boolean).join(' - ') || '-';
        ...
        function recordInspection(result) {
            return new Promise((resolve, reject) => {
                ...
                const reenable = () => btns.forEach(id => {
                    const b = document.getElementById(id);
                    if (b) {
                        b.disabled = false;
                        b.style.opacity = '';
                ...
                fetch(URL_RECORD, {
                    ...
                    .then(r => {
                        if (!r.ok) return r.text().then(t => {
                            throw new Error('Server ' + r.status + ': ' + t.substring(0, 200));
                        });
                        return r.json();
                    })
                    .then(data => {
                        ...
                        if (data.success) {
                            ...
                            toast('Inspection recorded (' + result + ').', result === 'Pass' ? 'success' : result === 'Fail' ? 'danger' : 'warning');
                            appendInspectedRow({
                                asset_tag: CURRENT_ASSET_TAG,
        ...
        function resetPassFailForm() {
            ['techInspNotes', 'techInspSerial', 'techInspDept', 'techInspRoom', 'techAssetInput'].forEach(id => {
            ...
            bootstrap.Tab.getOrCreateInstance(document.querySelector('[data-bs-target="#tech-not-inspected"]')).show();
        ...
        function renderNotInspected(items) {
            // IMPORTANT: destroy DataTable BEFORE changing innerHTML
            ...
            if (!items.length) {
                tbody.innerHTML = '<tr><td colspan="6" class="text-center text-muted">No equipment pending inspection.</td></tr>';
                badge.textContent = '0';
            ...
            tbody.innerHTML = items.map(eq => '<tr data-asset="' + esc(eq.asset_tag) + '">' +
                '<td><button class="btn btn-sm btn-primary" onclick="techInspectFromNotInspected(\'' + esc(eq.asset_tag) + '\')">' +
        ...
        function renderAllInventory(items) {
            ...
            if (!items.length) {
                tbody.innerHTML = '<tr><td colspan="5" class="text-center text-muted">No inventory found.</td></tr>';
                return;
            }
        ...
        function renderArchivedItems(items) {
            ...
            if (!archived.length) {
                tbody.innerHTML = '<tr><td colspan="5" class="text-center text-muted">No archived items found.</td></tr>';
                return;
            }
        ...
        function renderInspectedTable(items) {
            // IMPORTANT: destroy DataTable BEFORE changing DOM
            ...
            items.forEach((item, idx) => {
                ...
                tr.innerHTML =
                    '<td><button class="btn btn-sm btn-danger tech-del-inspected" data-id="' + esc(item.id || '') + '" data-idx="' + idx + '" title="Delete"><i class="fa-solid fa-trash"></i></button></td>' +
        ...
        function updateDeviceCounter(items) {
            ...
            if (!types.length) {
                tbody.innerHTML = '<tr><td colspan="4" class="text-center text-muted py-3">No inspected items yet.</td></tr>';
                return;
            }
            let tot = {
                total: 0,
            ...
            }).join('') + '<tr class="fw-bold table-secondary"><td>Total</td><td>' + tot.total + '</td><td>' + tot.est + '</td><td>' + tot.cal + '</td></tr>';
        }
        ...
        window.techOpenWorkOrderModal = function(assetTag) {
            ...
            document.getElementById('techWOModalTitle').textContent = assetTag ? 'Create Work Order for Failed Equipment' : 'Add Work Order';
        ...
        document.getElementById('techWOForm')?.addEventListener('submit', function(e) {
            ...
            if (!equipmentId) {
                errEl.textContent = 'Please select a valid asset so the equipment can be linked to this work order.';
                errEl.classList.remove('d-none');
            ...
            fetch('<?= site_url('technician/work-orders/create') ?>', {
                ...
                .then(data => {
                    ...
                    if (data.success || data.id) {
                        bootstrap.Modal.getInstance(document.getElementById('techWorkOrderModal')).hide();
        ...
        function loadWorkOrders(groupId) {
            ...
            fetch('<?= site_url('technician/inspections/groupWorkOrders') ?>?group_id=' + encodeURIComponent(groupId || '') + '&site_id=' + CURRENT_SITE_ID, {
                    headers: {
                        'X-Requested-With': 'XMLHttpRequest'
                    }
                })
        ...
        function renderWorkOrders(items) {
            ...
            if (!items.length) {
                tbody.innerHTML = '<tr><td colspan="10" class="text-center text-muted py-3">No work orders found.</td></tr>';
                return;
            }
            tbody.innerHTML = items.map(wo =>
                '<tr data-id="' + esc(wo.id || '') + '">' +
                '<td><button class="btn btn-sm btn-danger tech-wo-delete" data-id="' + esc(wo.id || '') + '" title="Delete"><i class="fa-solid fa-trash"></i></button></td>' +
                '<td>' + esc(wo.id || '') + '</td>' +
                '<td>' + esc(wo.title || '') + '</td>' +
        ...
        document.getElementById('techAddDeviceForm')?.addEventListener('submit', function(e) {
            ...
            const body = new URLSearchParams({
                ...
                action_performed: document.getElementById('techAddAction')?.value || 'Annual Performance Inspection',
            ...
            fetch(URL_RECORD, {
                ...
                .then(data => {
                    if (data.success) {
                        if (!CURRENT_GROUP_ID) CURRENT_GROUP_ID = data.group_id;
                        resetBtn();
                        bootstrap.Modal.getInstance(document.getElementById('techAddDeviceModal')).hide();
                        toast('New device added & inspected (' + result + ').', result === 'Pass' ? 'success' : 'warning');
                        appendInspectedRow({
                            asset_tag: document.getElementById('techAddAsset').value.trim(),
                        ...
                        if (msg.toLowerCase().includes('duplicate') || msg.toLowerCase().includes('asset_company')) {
                            msg = "Asset # already exists in this site's inventory. Use a different Asset # or scan the existing asset barcode directly.";
                        }
        ...
        function loadTechReport(groupId) {
            ...
            container.innerHTML = '<div class="text-center py-5"><i class="fa-solid fa-spinner fa-spin fa-2x text-primary"></i><p class="mt-3 text-muted">Loading report data...</p></div>';
            fetch(TECH_REPORT_DATA_URL + '?group_id=' + encodeURIComponent(groupId), {
                ...
                .then(data => {
                    if (!data.success) {
                        container.innerHTML = '<div class="alert alert-warning">No report data found for this inspection.</div>';
                        return;
                    }
                ...
                .catch(err => {
                    container.innerHTML = '<div class="alert alert-danger">Error loading report: ' + esc(err.message) + '</div>';
                });
        }
        ...
        window.techOpenInspectionReport = function(groupId) {
            TECH_CURRENT_REPORT_GROUP_ID = groupId;
            const rc = document.getElementById('techReportContent');
            if (rc) rc.innerHTML = '<div class="text-center py-5"><i class="fa-solid fa-spinner fa-spin fa-2x text-primary"></i><p class="mt-3 text-muted">Loading...</p></div>';
            ...
            fetch(TECH_REPORT_DATA_URL + '?group_id=' + encodeURIComponent(groupId), {
                ...
                .then(r => r.json())
                .then(data => {
                    const html = data.success ? techGenerateReportHTML(data.latest, data.rows, data.group_id || groupId) : '<div class="alert alert-warning">No report data found.</div>';
                    if (rc) rc.innerHTML = html;
        ...
        document.getElementById('techPreviewReportBtn')?.addEventListener('click', function() {
            ...
            window.open(TECH_REPORT_PREVIEW_URL + '/' + encodeURIComponent(g), '_blank');
        });
        document.getElementById('techDownloadReportBtn')?.addEventListener('click', function() {
            ...
            window.open(TECH_REPORT_PDF_URL + '/' + encodeURIComponent(g), '_blank');
        });
        document.getElementById('techPreviewPDFBtn')?.addEventListener('click', function() {
            ...
            if (g) window.open(TECH_REPORT_PREVIEW_URL + '/' + encodeURIComponent(g), '_blank');
        });
        document.getElementById('techDownloadPDFBtn')?.addEventListener('click', function() {
            const g = TECH_CURRENT_REPORT_GROUP_ID || CURRENT_GROUP_ID;
            if (g) window.open(TECH_REPORT_PDF_URL + '/' + encodeURIComponent(g), '_blank');
        });
            ...
            if (!rowsArr.length) {
                ...
                order.forEach(st => {
                    ...
                    rowsHtml += '<tr style="background:#f8fafc;"><td colspan="12" class="py-2 px-3">' +
                        ...
                        '<span class="text-muted small">' + groups[st].length + ' device' + (groups[st].length !== 1 ? 's' : '') + '</span></td></tr>';
                    groups[st].forEach(r => {
                        const badge = r.result === 'Pass' || r.status === 'Pass' ?
                            ...
                            '<span class="text-warning fw-semibold"><i class="fa-solid fa-wrench me-1"></i>' + esc(r.result || r.status) + '</span>';
                        const attRow = (r.result === 'Fail' || r.status === 'Fail') ?
                            '<tr><td colspan="12"><div class="attention-required mt-1">Attention Required - Equipment Failure</div></td></tr>' : '';
                        rowsHtml +=
                            '<tr><td>' + badge + '</td>' +
                            ...
                            '<td class="small text-muted">' + esc(r.notes || '') + '</td></tr>' + attRow;
                    });
                });
            }
            return '<section><h5 class="fw-semibold mb-3">Inspection Report Overview</h5>' +
                '<div class="alert alert-danger" role="alert"><i class="fa-solid fa-exclamation-triangle me-2"></i>' +
                '<strong>Critical:</strong> Review all failed items marked as "Attention Required" below. Failed equipment requires immediate attention and work order creation.</div>' +
                '<div class="table-responsive"><table class="table table-custom table-striped">' +
                '<thead><tr><th>Result</th><th>Customer</th><th>Model</th><th>Type</th><th>S/N</th>' +
                '<th>Action Performed</th><th>Asset #</th><th>Dept</th><th>Room</th><th>Tech</th><th>Date</th><th>Notes</th></tr></thead>' +
