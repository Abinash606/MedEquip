                    ...
                    <div class="tab-content">
                            ...
                            <div class="d-flex justify-content-between align-items-center mb-3 flex-wrap gap-2">
                                ...
                                <div class="tech-export-bar">
                                    <button class="tech-export-btn"
                                        onclick="techExportTable('copy','techNotInspTable')">Copy</button>
                                    <button class="tech-export-btn"
                                        onclick="techExportTable('csv','techNotInspTable','not-inspected')">CSV</button>
                                    <button class="tech-export-btn"
                                        onclick="techExportTable('excel','techNotInspTable','not-inspected')">Excel</button>
                                    <button class="tech-export-btn"
                                        onclick="techExportTable('pdf','techNotInspTable','not-inspected')">PDF</button>
                                </div>
                        ...
                        <div class="tab-pane fade p-4" id="tech-inspected" role="tabpanel">
                            <div class="tech-inspected-topbar mb-4">
                                ...
                                <div class="tech-inspected-center">
                                    <div class="tech-export-bar">
                                        <button class="tech-export-btn"
                                            onclick="techExportTable('copy','techInspectedTable')">Copy</button>
                                        <button class="tech-export-btn"
                                            onclick="techExportTable('csv','techInspectedTable','inspected-items')">CSV</button>
                                        <button class="tech-export-btn"
                                            onclick="techExportTable('excel','techInspectedTable','inspected-items')">Excel</button>
                                        <button class="tech-export-btn"
                                            onclick="techExportTable('pdf','techInspectedTable','inspected-items')">PDF</button>
                                    </div>
                                </div>
                        ...
                        <div class="tab-pane fade p-4" id="tech-inventory" role="tabpanel">
                            <div class="d-flex justify-content-between align-items-center mb-3 flex-wrap gap-2">
                                ...
                                <div class="tech-export-bar">
                                    <button class="tech-export-btn"
                                        onclick="techExportTable('copy','techInventoryTable')">Copy</button>
                                    <button class="tech-export-btn"
                                        onclick="techExportTable('csv','techInventoryTable','all-inventory')">CSV</button>
                                    <button class="tech-export-btn"
                                        onclick="techExportTable('excel','techInventoryTable','all-inventory')">Excel</button>
                                    <button class="tech-export-btn"
                                        onclick="techExportTable('pdf','techInventoryTable','all-inventory')">PDF</button>
                                </div>
                                <div class="input-group" style="max-width:300px">
                                    <span class="input-group-text border-end-0"><i
                                            class="fa-solid fa-search text-muted"></i></span>
                        ...
                        <div class="tab-pane fade p-4" id="tech-archived" role="tabpanel">
                            <div class="d-flex justify-content-between align-items-center mb-3 flex-wrap gap-2">
                                ...
                                <div class="tech-export-bar">
                                    <button class="tech-export-btn"
                                        onclick="techExportTable('copy','techArchivedTable')">Copy</button>
                                    <button class="tech-export-btn"
                                        onclick="techExportTable('csv','techArchivedTable','archived-items')">CSV</button>
                                    <button class="tech-export-btn"
                                        onclick="techExportTable('excel','techArchivedTable','archived-items')">Excel</button>
                                    <button class="tech-export-btn"
                                        onclick="techExportTable('pdf','techArchivedTable','archived-items')">PDF</button>
                                </div>
                                <div class="input-group" style="max-width:300px">
                                    <span class="input-group-text border-end-0"><i
                                            class="fa-solid fa-search text-muted"></i></span>
                        ...
                        <div class="tab-pane fade p-4" id="tech-work-orders" role="tabpanel">
                            ...
                            <div class="d-flex justify-content-between align-items-center flex-wrap gap-3 mb-3">
                                <div class="tech-export-bar">
                                    <button class="tech-export-btn"
                                        onclick="techExportTable('copy','techWOTable')">Copy</button>
                                    <button class="tech-export-btn"
                                        onclick="techExportTable('csv','techWOTable','work-orders')">CSV</button>
                                    <button class="tech-export-btn"
                                        onclick="techExportTable('excel','techWOTable','work-orders')">Excel</button>
                                    <button class="tech-export-btn"
                                        onclick="techExportTable('pdf','techWOTable','work-orders')">PDF</button>
                                </div>
                                <div class="input-group" style="max-width:300px">
                                    <span class="input-group-text border-end-0"><i
                                            class="fa-solid fa-search text-muted"></i></span>
                            ...
                            <div class="row g-3">
                                ...
                                <div class="col-12">
                                    ...
                                    <div class="d-flex flex-wrap gap-2">
                                        <button class="btn btn-success" id="techAddBtnPass" type="button"><i
                                                class="fa-solid fa-check me-1"></i>Pass</button>
                                        <button class="btn btn-danger" id="techAddBtnFail" type="button"><i
                                                class="fa-solid fa-xmark me-1"></i>Fail</button>
                                        <button class="btn btn-warning text-white" id="techAddBtnRepair"
                                            type="button"><i class="fa-solid fa-wrench me-1"></i>Repair</button>
                                    </div>
