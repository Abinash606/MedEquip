            ...
            <div class="modal-body">
                <form>
                    <div class="row g-3">
                        ...
                        <div class="col-md-6"><label class="form-label">Device Status</label><select class="form-select" id="equipment-status"><option selected>Ready</option><option>Need Attention</option><option>Not Ready</option></select></div>
                        <div class="col-md-6"><label class="form-label">PM Kit</label><select class="form-select"><option selected>Select PM Kit</option><option>Basic Kit</option><option>Full Kit</option><option>Calibration Only</option></select></div>
                        ...
                        <div class="col-12"><label class="form-label">Customer Location</label><select class="form-select"><option>Mercy Hospital</option><option>Downtown Clinic</option></select></div>
            ...
            <div class="modal-body">
                <form>
                    <div class="row g-3">
                        ...
                        <div class="col-md-6">
                            <label for="technician-username" class="form-label">Username</label>
                            <input type="text" class="form-control" id="technician-username">
                        </div>
                        <div class="col-md-6">
                            <label for="technician-password" class="form-label">Password</label>
                            <input type="password" class="form-control" id="technician-password">
                        </div>
                        <div class="col-md-6">
                        ...
                        <div class="col-12 mt-3">
                            ...
                            <div class="row row-cols-2 row-cols-md-3 row-cols-lg-5 g-2">
                                <div class="col"><div class="form-check"><input class="form-check-input" type="checkbox" value="AL" id="state-al"><label class="form-check-label small" for="state-al">Alabama</label></div></div>
                                <div class="col"><div class="form-check"><input class="form-check-input" type="checkbox" value="AK" id="state-ak"><label class="form-check-label small" for="state-ak">Alaska</label></div></div>
                                <div class="col"><div class="form-check"><input class="form-check-input" type="checkbox" value="AZ" id="state-az"><label class="form-check-label small" for="state-az">Arizona</label></div></div>
                                <div class="col"><div class="form-check"><input class="form-check-input" type="checkbox" value="AR" id="state-ar"><label class="form-check-label small" for="state-ar">Arkansas</label></div></div>
                                <div class="col"><div class="form-check"><input class="form-check-input" type="checkbox" value="CA" id="state-ca"><label class="form-check-label small" for="state-ca">California</label></div></div>
                                
                                <div class="col"><div class="form-check"><input class="form-check-input" type="checkbox" value="CO" id="state-co"><label class="form-check-label small" for="state-co">Colorado</label></div></div>
                                <div class="col"><div class="form-check"><input class="form-check-input" type="checkbox" value="CT" id="state-ct"><label class="form-check-label small" for="state-ct">Connecticut</label></div></div>
                                <div class="col"><div class="form-check"><input class="form-check-input" type="checkbox" value="DE" id="state-de"><label class="form-check-label small" for="state-de">Delaware</label></div></div>
                                <div class="col"><div class="form-check"><input class="form-check-input" type="checkbox" value="DC" id="state-dc"><label class="form-check-label small" for="state-dc">District of Columbia</label></div></div>
                                <div class="col"><div class="form-check"><input class="form-check-input" type="checkbox" value="FL" id="state-fl"><label class="form-check-label small" for="state-fl">Florida</label></div></div>
                                
                                <div class="col"><div class="form-check"><input class="form-check-input" type="checkbox" value="GA" id="state-ga"><label class="form-check-label small" for="state-ga">Georgia</label></div></div>
                                <div class="col"><div class="form-check"><input class="form-check-input" type="checkbox" value="HI" id="state-hi"><label class="form-check-label small" for="state-hi">Hawaii</label></div></div>
                                <div class="col"><div class="form-check"><input class="form-check-input" type="checkbox" value="ID" id="state-id"><label class="form-check-label small" for="state-id">Idaho</label></div></div>
                                <div class="col"><div class="form-check"><input class="form-check-input" type="checkbox" value="IL" id="state-il"><label class="form-check-label small" for="state-il">Illinois</label></div></div>
                                <div class="col"><div class="form-check"><input class="form-check-input" type="checkbox" value="IN" id="state-in"><label class="form-check-label small" for="state-in">Indiana</label></div></div>
                                
                                <div class="col"><div class="form-check"><input class="form-check-input" type="checkbox" value="IA" id="state-ia"><label class="form-check-label small" for="state-ia">Iowa</label></div></div>
                                <div class="col"><div class="form-check"><input class="form-check-input" type="checkbox" value="KS" id="state-ks"><label class="form-check-label small" for="state-ks">Kansas</label></div></div>
                                <div class="col"><div class="form-check"><input class="form-check-input" type="checkbox" value="KY" id="state-ky"><label class="form-check-label small" for="state-ky">Kentucky</label></div></div>
                                <div class="col"><div class="form-check"><input class="form-check-input" type="checkbox" value="LA" id="state-la"><label class="form-check-label small" for="state-la">Louisiana</label></div></div>
                                <div class="col"><div class="form-check"><input class="form-check-input" type="checkbox" value="ME" id="state-me"><label class="form-check-label small" for="state-me">Maine</label></div></div>
                                
                                <div class="col"><div class="form-check"><input class="form-check-input" type="checkbox" value="MD" id="state-md"><label class="form-check-label small" for="state-md">Maryland</label></div></div>
                                <div class="col"><div class="form-check"><input class="form-check-input" type="checkbox" value="MA" id="state-ma"><label class="form-check-label small" for="state-ma">Massachusetts</label></div></div>
                                <div class="col"><div class="form-check"><input class="form-check-input" type="checkbox" value="MI" id="state-mi"><label class="form-check-label small" for="state-mi">Michigan</label></div></div>
                                <div class="col"><div class="form-check"><input class="form-check-input" type="checkbox" value="MN" id="state-mn"><label class="form-check-label small" for="state-mn">Minnesota</label></div></div>
                                <div class="col"><div class="form-check"><input class="form-check-input" type="checkbox" value="MS" id="state-ms"><label class="form-check-label small" for="state-ms">Mississippi</label></div></div>
                                
                                <div class="col"><div class="form-check"><input class="form-check-input" type="checkbox" value="MO" id="state-mo"><label class="form-check-label small" for="state-mo">Missouri</label></div></div>
                                <div class="col"><div class="form-check"><input class="form-check-input" type="checkbox" value="MT" id="state-mt"><label class="form-check-label small" for="state-mt">Montana</label></div></div>
                                <div class="col"><div class="form-check"><input class="form-check-input" type="checkbox" value="NE" id="state-ne"><label class="form-check-label small" for="state-ne">Nebraska</label></div></div>
                                <div class="col"><div class="form-check"><input class="form-check-input" type="checkbox" value="NV" id="state-nv"><label class="form-check-label small" for="state-nv">Nevada</label></div></div>
                                <div class="col"><div class="form-check"><input class="form-check-input" type="checkbox" value="NH" id="state-nh"><label class="form-check-label small" for="state-nh">New Hampshire</label></div></div>
                                
                                <div class="col"><div class="form-check"><input class="form-check-input" type="checkbox" value="NJ" id="state-nj"><label class="form-check-label small" for="state-nj">New Jersey</label></div></div>
                                <div class="col"><div class="form-check"><input class="form-check-input" type="checkbox" value="NM" id="state-nm"><label class="form-check-label small" for="state-nm">New Mexico</label></div></div>
                                <div class="col"><div class="form-check"><input class="form-check-input" type="checkbox" value="NY" id="state-ny"><label class="form-check-label small" for="state-ny">New York</label></div></div>
                                <div class="col"><div class="form-check"><input class="form-check-input" type="checkbox" value="NC" id="state-nc"><label class="form-check-label small" for="state-nc">North Carolina</label></div></div>
                                <div class="col"><div class="form-check"><input class="form-check-input" type="checkbox" value="ND" id="state-nd"><label class="form-check-label small" for="state-nd">North Dakota</label></div></div>
                                
                                <div class="col"><div class="form-check"><input class="form-check-input" type="checkbox" value="OH" id="state-oh"><label class="form-check-label small" for="state-oh">Ohio</label></div></div>
                                <div class="col"><div class="form-check"><input class="form-check-input" type="checkbox" value="OK" id="state-ok"><label class="form-check-label small" for="state-ok">Oklahoma</label></div></div>
                                <div class="col"><div class="form-check"><input class="form-check-input" type="checkbox" value="OR" id="state-or"><label class="form-check-label small" for="state-or">Oregon</label></div></div>
                                <div class="col"><div class="form-check"><input class="form-check-input" type="checkbox" value="PA" id="state-pa"><label class="form-check-label small" for="state-pa">Pennsylvania</label></div></div>
                                <div class="col"><div class="form-check"><input class="form-check-input" type="checkbox" value="RI" id="state-ri"><label class="form-check-label small" for="state-ri">Rhode Island</label></div></div>
                                
                                <div class="col"><div class="form-check"><input class="form-check-input" type="checkbox" value="SC" id="state-sc"><label class="form-check-label small" for="state-sc">South Carolina</label></div></div>
                                <div class="col"><div class="form-check"><input class="form-check-input" type="checkbox" value="SD" id="state-sd"><label class="form-check-label small" for="state-sd">South Dakota</label></div></div>
                                <div class="col"><div class="form-check"><input class="form-check-input" type="checkbox" value="TN" id="state-tn"><label class="form-check-label small" for="state-tn">Tennessee</label></div></div>
                                <div class="col"><div class="form-check"><input class="form-check-input" type="checkbox" value="TX" id="state-tx"><label class="form-check-label small" for="state-tx">Texas</label></div></div>
                                <div class="col"><div class="form-check"><input class="form-check-input" type="checkbox" value="UT" id="state-ut"><label class="form-check-label small" for="state-ut">Utah</label></div></div>
                                
                                <div class="col"><div class="form-check"><input class="form-check-input" type="checkbox" value="VT" id="state-vt"><label class="form-check-label small" for="state-vt">Vermont</label></div></div>
                                <div class="col"><div class="form-check"><input class="form-check-input" type="checkbox" value="VA" id="state-va"><label class="form-check-label small" for="state-va">Virginia</label></div></div>
                                <div class="col"><div class="form-check"><input class="form-check-input" type="checkbox" value="WA" id="state-wa"><label class="form-check-label small" for="state-wa">Washington</label></div></div>
                                <div class="col"><div class="form-check"><input class="form-check-input" type="checkbox" value="WV" id="state-wv"><label class="form-check-label small" for="state-wv">West Virginia</label></div></div>
                                <div class="col"><div class="form-check"><input class="form-check-input" type="checkbox" value="WI" id="state-wi"><label class="form-check-label small" for="state-wi">Wisconsin</label></div></div>
                                
                                <div class="col"><div class="form-check"><input class="form-check-input" type="checkbox" value="WY" id="state-wy"><label class="form-check-label small" for="state-wy">Wyoming</label></div></div>
                            </div>
                        </div>
                    </div>
                </form>
            ...
            <div class="modal-body">
                ...
                <div class="site-inspection-step" id="site-inspection-step-3" style="display: none;">
                    ...
                    <div class="row g-3">
                        ...
                        <div class="col-md-6"><label class="form-label">PM Service Frequency</label><select class="form-select" id="site-pm-frequency"><option value="" disabled selected>Select frequency</option><option>6 Month</option><option>12 Month</option><option>24 Month</option></select></div>
                        <div class="col-md-6"><label class="form-label">Inspection Type</label><select class="form-select" id="site-inspection-type"><option value="" disabled selected>Select type</option><option>Annual Performance Inspection</option><option>Preventive Maintenance</option><option>Safety Check</option></select></div>
                        ...
                        <div class="col-md-6"><label class="form-label">Status</label><select class="form-select" id="site-status"><option>Pass</option><option>Fail</option><option>Repaired</option></select></div>
                        <div class="col-md-6"><label class="form-label">Device Complete</label><select class="form-select" id="site-device-completion"><option>Yes</option><option>No</option></select></div>
                    </div>
                    <div class="mt-3 text-center">
