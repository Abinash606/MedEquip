...
<div class="d-flex justify-content-between align-items-center mb-4 flex-wrap gap-2">
        ...
        <div class="glass-card">
            <div class="d-flex justify-content-between align-items-center mb-4 border-bottom pb-3">
                ...
                <button class="btn btn-primary btn-sm" data-bs-toggle="modal" data-bs-target="#appointmentModal"><i class="fa-solid fa-plus"></i> Add Appointment</button>
            </div>
            ...
            <div class="d-flex justify-content-between align-items-start mb-3">
                ...
                <div class="bg-light border rounded p-2" style="min-width: 200px;">
                    ...
                    <div id="timelineDayView" class="timeline-view active">
                        <div class="gantt-container">
                            ...
                            <div class="gantt-row">
                                ...
                                <div class="gantt-timeline">
                                     <div class="gantt-bar bg-warning text-dark" style="left: 60%; width: 15%;" title="Travel">Travel</div>
